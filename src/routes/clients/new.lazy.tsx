...
export default function RouteComponent() {
  const [clientType, setClientType] = useState<"type.particulier" | "type.professionnel">(
    "type.particulier"
  );
    ...
    >
      {country.name} ({country.callingCodes?.[0] || "N/A"})
        ...
        <input
          ...
          name="phone"
          value={`${phoneNumber}`}
          onChange={(e) => handlePhoneNumberChange(e.target.value, setPhoneNumber, setFormData, formData)}
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="code-postal"  type="number"    name="cp"
                     value={formData.cp}
                    onChange={(e) => handleChange(e, setFormData, formData)}
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="bareme-cee" required  name="precarite"
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="code-postal-pro" required  type="number"    name="cp"
                        value={formData.cp}
                        onChange={(e) => handleChange(e, setFormData, formData)}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="ville-pro" required     name="ville"
                        value={formData.ville}
                        onChange={(e) => handleChange(e, setFormData, formData)}
    ...
    >
      {country.name} ({country.callingCodes?.[0] || "N/A"})
        ...
        <input
          ...
          name="phone"
          value={`${phoneNumberE}`}
          onChange={(e) => handlePhoneNumberChangeE(e.target.value, setPhoneNumberE, setFormData, formData)}
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input id="nom-contact" required   name="nom"
                        value={formData.nom}
                        onChange={(e) => handleChange(e, setFormData, formData)}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="poste" required   name="poste"
      ...
      {country.name} ({country.callingCodes?.[0] || "N/A"})
        ...
        />
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="email-contact" type="email" required   name="email"
                        value={formData.email}
                        onChange={(e) => handleChange(e, setFormData, formData)}
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="forme_juridique" required 
