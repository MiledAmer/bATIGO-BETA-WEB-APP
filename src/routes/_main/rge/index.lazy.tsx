...
export const Route = createLazyFileRoute('/_main/rge/')({
    ...
    <div className="w-full">
      ...
      <div className="flex items-center justify-end space-x-2 py-4">
        <div className="flex-1 text-sm text-muted-foreground">
          {certificat_rge?.current_page * certificat_rge?.per_page} of{' '}
          {certificat_rge?.total} row(s) selected.
        </div>
